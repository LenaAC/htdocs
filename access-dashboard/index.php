...
<body>
	...
	<div class="container" style="padding-top:100px;">
		<div style="padding: 15px;" class="well">
			...
			<br>
			<i style="color: #a5a5a5;">Login to <a href="../dashboard/login" style="color: #a5a5a5;">Charon</a> Copyright <i aria-hidden="true" class="fa fa-copyright"></i> Charon - All rights reserved.</i>
		</div>
	</div>
	<style type="text/css">
	   #container2{
