...
<head>
	...
	<meta content="Official Exspiravit Market Website" name="description">
	<meta content="Exspiravit" name="keywords">
...
<body>
	...
	<div class="container" style="padding-top:100px;">
		<div style="padding: 15px;" class="well">
			...
			<b>About</b><br>
			<br>
			This is a Discord Server which is only accessible through pre-approval by the Owner/Staff.<br>
			<span style="font-size: 10px; border: 1px solid #ff00c4; border-radius: 3px; padding: 3px;"><i class="fa fa-info-circle"></i> We have a private Discord Server, login to our <a href="//dashboard.charon.gg/" style="text-decoration: none;" target="_blank"><b>Dashboard</b></a> and request access by clicking the <i class="fa fa-plus"></i> icon, or contact us on <a href="https://twitter.com/exxxxxsm" style="text-decoration: none;" target="_blank">Twitter</a> or email us at <a href="mailto:contact@charon.gg" style="text-decoration: none;">contact@charon.gg</a> with any inquiries that you may have.</span><br>
			<br>
			...
			<br>
			<i style="color: #a5a5a5;"><i class="fa fa-home"></i> <a href="https://charon.gg/" style="color: #a5a5a5;">Charon</a> <i class="fa fa-key"></i><a href="https://keybase.io/mythical" style="color: #a5a5a5;">Keybase</a> Copyright <i aria-hidden="true" class="fa fa-copyright"></i> Charon - All rights reserved.</i>
		</div>
	</div>
	<style type="text/css">
	   #container2{
