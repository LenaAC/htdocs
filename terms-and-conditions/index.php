...
<html>
<head>
	<title>Charon | Terms and Conditions</title>
...
<body>
	...
	<div class="container" style="padding-top:100px;">
		<div style="padding: 15px;" class="well">
			...
			<h2>Welcome to Charon</h2>
			<p>These terms and conditions outline the rules and regulations for the use of Charon's Website.</p><span style="text-transform: capitalize;">Contact Charon</span> at:<br>
			<address>
				<a href="mailto:contact@charon.gg" style="text-decoration: none;">contact@charon.gg</a><br>
			</address>
			<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Charon's website if you do not accept all of the terms and conditions stated on this page.</p>
			<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any or all Agreements: "Client", "You" and "Your" refers to you, the person accessing this website and accepting the Company's terms and conditions. "Charon", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves, or either the Client or ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner, whether by formal meetings of a fixed duration, or any other means, for the express purpose of meeting the Client's needs in respect of provision of the Company's stated services/products, in accordance with and subject to, prevailing law of United States. Any use of the above terminology or other words in the singular, plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
			<h2>Cookies</h2>
			<p>We employ the use of cookies. By using Charon's website you consent to the use of cookies in accordance with Charon's privacy policy.</p>
			...
			<h2>License</h2>
			<p>Unless otherwise stated, Charon and/or it's licensors own the intellectual property rights for all material on Charon. All intellectual property rights are reserved. You may view and/or print pages from https://charon.gg/ for your own personal use subject to restrictions set in these terms and conditions.</p>
			<p>You must not:</p>
			<ol>
				<li>Republish material from https://charon.gg/</li>
				<li>Sell, rent or sub-license material from https://charon.gg/</li>
				<li>Reproduce, duplicate or copy material from https://charon.gg/</li>
			</ol>
			<p>Redistribute content from Charon (unless content is specifically made for redistribution).</p>
			...
			<p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a href="mailto:Contact@charon.gg" title="send an email to Contact@charon.gg">Contact@charon.gg</a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
			...
			<p>No use of Charon's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
			<h2>Iframes</h2>
			...
			<p>This Terms and conditions page was created at <a href="https://charon.gg/" style="color:inherit;text-decoration:none;cursor:text;">7/14/2019</a>. If you have any queries regarding any of our terms, please contact us.</p><i style="color: #a5a5a5;"><i class="fa fa-home"></i> <a href="https://charon.gg/" style="color: #a5a5a5;">Charon</a> <i class="fa fa-key"></i><a href="https://keybase.io/mythical" style="color: #a5a5a5;">Keybase</a> Copyright <i aria-hidden="true" class="fa fa-copyright"></i> Charon - All rights reserved.</i>
		</div>
	</div>
	...
	<footer>
		<div class="footer">
			...
			<b><a href="https://charon.gg" style="text-decoration: none; color: #fff; font-size: 20px;"><i class="fa fa-long-arrow-left"></i> Home</a></b>
			<footer>
				<b></b>
			</footer>
		</div>
